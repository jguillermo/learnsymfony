 ...
 */
class Version20170215035709 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE person (id VARCHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, lastName VARCHAR(50) NOT NULL, secondLastName VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
